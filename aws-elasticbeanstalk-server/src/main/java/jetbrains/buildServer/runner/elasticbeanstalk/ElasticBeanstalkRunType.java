...
public class ElasticBeanstalkRunType extends RunType {
  @NotNull
  ...
  public ElasticBeanstalkRunType(@NotNull RunTypeRegistry registry,
  ...
  private static String registerController(@NotNull final PluginDescriptor descriptor,
    ...
    controllerManager.registerController(resolvedHtmlPath, new BaseController() {
      ...
      protected ModelAndView doHandle(@NotNull HttpServletRequest request, @NotNull HttpServletResponse response) throws Exception {
        return new ModelAndView(descriptor.getPluginResourcesPath(jspPath));
      }
    });
  ...
  public String describeParameters(@NotNull Map<String, String> parameters) {
    ...
    return invalids.isEmpty() ? "Application revision" : ElasticBeanstalkUtil.printStrings(invalids.values());
  }
}
