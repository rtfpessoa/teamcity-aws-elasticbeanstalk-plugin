...
public class ElasticBeanstalkBuildProblemTypes {

  public ElasticBeanstalkBuildProblemTypes(@NotNull ExtensionHolder extensionHolder) {
    register(ElasticBeanstalkConstants.TIMEOUT_BUILD_PROBLEM_TYPE, "ElasticBeanstalk timeout", extensionHolder);
    register(ElasticBeanstalkConstants.FAILURE_BUILD_PROBLEM_TYPE, "ElasticBeanstalk failure", extensionHolder);
